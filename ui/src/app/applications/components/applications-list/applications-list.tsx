...
import {ClusterSettingsCtx, Consumer, Context, ContextApis} from '../../../shared/context';
...
const SearchBar = (props: {content: string; ctx: ContextApis; apps: models.Application[]}) => {
    ...
    return (
        <Autocomplete
            ...
            value={content || ''}
            items={apps.map(app => AppUtils.appQualifiedName(app, useClusterSettingsCtx?.appsInAnyNamespaceEnabled))}
        />
    );
};
